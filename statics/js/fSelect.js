// https://www.cnblogs.com/sherryweb/p/11057746.html
    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            create: function() {
                ...
                if (this.$select.hasClass("fappium")) {
                    this.$select.wrap('<div class="fs-wrap fs-wrap-width_90' + multiple + '"></div>');
                }else if (this.$select.hasClass("fwda")){
                    this.$select.wrap('<div class="fs-wrap fs-wda-select-width' + multiple + '"></div>');
                }else if (this.$select.hasClass("fui_auto")){
                    this.$select.wrap('<div class="fs-wrap fs-ui-select-width' + multiple + '"></div>');
                }else{
                ...
                if (this.$select.hasClass("fappium")) {
                    this.$select.before('<div class="fs-dropdown fs-appium hidden"><div class="fs-options"></div></div>');
                }else if (this.$select.hasClass("fwda")){
                    this.$select.before('<div class="fs-dropdown fs-wda hidden"><div class="fs-options"></div></div>');
                }else if (this.$select.hasClass("fui_auto")){
                    this.$select.before('<div class="fs-dropdown fs-ui_auto hidden"><div class="fs-options"></div></div>');
                }else if (this.$select.hasClass("fbankSec")){
                    this.$select.before('<div class="fs-dropdown fs-bankSec hidden"><div class="fs-options"></div></div>');
                }else{
                ...
                //添加全选和清空按钮
                var BtnFixed = '<div class="btnFixed"><button class="buttonDefault" id="clearAllBtn" type="button">清空</button><button class="buttonDefault" id="selectAllBtn" type="button">全选</button></div>';
            ...
            reloadDropdownLabel: function() {
                ...
                this.$wrap.find('.fs-label').attr("value",labelText.join(', '));
